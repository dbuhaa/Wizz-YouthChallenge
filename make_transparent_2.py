...
if __name__ == "__main__":
    ...
    # Process medium coin
    medium_coins = glob.glob(f"{brain_dir}/coin_medium_*.png")
    if medium_coins:
        make_transparent_green(medium_coins[-1], f"{public_dir}/coin_medium.png")
        
    # Process large coin
    large_coins = glob.glob(f"{brain_dir}/coin_large_*.png")
    if large_coins:
